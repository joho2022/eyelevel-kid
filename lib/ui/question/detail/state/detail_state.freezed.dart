...
mixin _$DetailState {
 ...
 QuestionRecord? get record; bool get isInitialLoading;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DetailState&&(identical(other.record, record) || other.record == record)&&(identical(other.isInitialLoading, isInitialLoading) || other.isInitialLoading == isInitialLoading));
}


@override
int get hashCode => Object.hash(runtimeType,record,isInitialLoading);

@override
String toString() {
  return 'DetailState(record: $record, isInitialLoading: $isInitialLoading)';
}
...
@useResult
$Res call({
 QuestionRecord? record, bool isInitialLoading
});
...
/// Create a copy of DetailState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? record = freezed,Object? isInitialLoading = null,}) {
  return _then(_self.copyWith(
record: freezed == record ? _self.record : record // ignore: cast_nullable_to_non_nullable
as QuestionRecord?,isInitialLoading: null == isInitialLoading ? _self.isInitialLoading : isInitialLoading // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( QuestionRecord? record,  bool isInitialLoading)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DetailState() when $default != null:
return $default(_that.record,_that.isInitialLoading);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( QuestionRecord? record,  bool isInitialLoading)  $default,) {final _that = this;
switch (_that) {
case _DetailState():
return $default(_that.record,_that.isInitialLoading);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( QuestionRecord? record,  bool isInitialLoading)?  $default,) {final _that = this;
switch (_that) {
case _DetailState() when $default != null:
return $default(_that.record,_that.isInitialLoading);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DetailState&&(identical(other.record, record) || other.record == record)&&(identical(other.isInitialLoading, isInitialLoading) || other.isInitialLoading == isInitialLoading));
}
...
/// Create a copy of DetailState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? record = freezed,Object? isInitialLoading = null,}) {
