...
mixin _$MyState {
 ...
 String get nickname; String? get profileImageUrl; AnswerStyle get answerStyle; bool get isLoading; String get appVersion; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,nickname,profileImageUrl,answerStyle,isLoading,appVersion,errorMessage);

@override
String toString() {
  return 'MyState(nickname: $nickname, profileImageUrl: $profileImageUrl, answerStyle: $answerStyle, isLoading: $isLoading, appVersion: $appVersion, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 String nickname, String? profileImageUrl, AnswerStyle answerStyle, bool isLoading, String appVersion, String? errorMessage
});
...
/// Create a copy of MyState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? nickname = null,Object? profileImageUrl = freezed,Object? answerStyle = null,Object? isLoading = null,Object? appVersion = null,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String nickname,  String? profileImageUrl,  AnswerStyle answerStyle,  bool isLoading,  String appVersion,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MyState() when $default != null:
return $default(_that.nickname,_that.profileImageUrl,_that.answerStyle,_that.isLoading,_that.appVersion,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String nickname,  String? profileImageUrl,  AnswerStyle answerStyle,  bool isLoading,  String appVersion,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _MyState():
return $default(_that.nickname,_that.profileImageUrl,_that.answerStyle,_that.isLoading,_that.appVersion,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String nickname,  String? profileImageUrl,  AnswerStyle answerStyle,  bool isLoading,  String appVersion,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _MyState() when $default != null:
return $default(_that.nickname,_that.profileImageUrl,_that.answerStyle,_that.isLoading,_that.appVersion,_that.errorMessage);case _:
  return null;
...
class _MyState implements MyState {
  const _MyState({required this.nickname, this.profileImageUrl, required this.answerStyle, required this.isLoading, required this.appVersion, this.errorMessage});
...
/// Create a copy of MyState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? nickname = null,Object? profileImageUrl = freezed,Object? answerStyle = null,Object? isLoading = null,Object? appVersion = null,Object? errorMessage = freezed,}) {
